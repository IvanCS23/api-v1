...
class CancelInvoiceWithPacRequest extends FormRequest
{
    private const RESERVED_FIELDS = ['company_id', 'pac_external_id', 'cfdi_uuid', 'pac_status'];
    ...
    {
        return [
            'motive' => ['required', new Enum(CfdiCancellationMotive::class)],
            'substitution_uuid' => [
                'nullable',
